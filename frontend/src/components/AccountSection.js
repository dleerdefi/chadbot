...
const AccountSection = ({ user, setUser, collapsed }) => {
  ...
  return (
    <div className="account-section">
      ...
      <img src={fullProfilePicUrl} alt="Profile" className="account-section__avatar" />
      <input type="file" onChange={handleFileUpload} accept="image/*" className="account-section__file-input" />
      ...
      <button onClick={updateProfile} className="account-section__button">Update Profile</button>
      {error && <p className="account-section__error">{error}</p>}
      {success && <p className="account-section__success">{success}</p>}
      <button onClick={handleLogout} className="account-section__button account-section__button--logout">Log Out</button>
      <button onClick={handleDeleteAccount} className="account-section__button account-section__button--delete">Delete Account</button>
    </div>
  );
};
